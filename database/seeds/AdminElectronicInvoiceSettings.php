...
class AdminElectronicInvoiceSettings extends Seeder
{
    ...
    public function run()
    {
       \App\Models\ElectronicInvoiceSettings::create([
        	'user_id'=>38,
        	'type'=>\App\Models\ElectronicInvoiceSettings::MEDIAFORM,
       ...
       \App\Models\ElectronicInvoiceSettings::create([
        	'user_id'=>38,
        	'type'=>\App\Models\ElectronicInvoiceSettings::LRN,
        	'dati_trasmissione_id_paese'=>"IT",
        	'dati_trasmissione_id_codice'=>"10209790152",
        	'dati_anagrafici_id_paese'=>"IT",
        	'dati_anagrafici_id_codice'=>"07240111216",
       ...
       \App\Models\ElectronicInvoiceSettings::create([
        	'user_id'=>38,
        	'type'=>\App\Models\ElectronicInvoiceSettings::DILE,
        	'dati_trasmissione_id_paese'=>"IT",
        	'dati_trasmissione_id_codice'=>"10209790152",
        	'dati_anagrafici_id_paese'=>"IT",
        	'dati_anagrafici_id_codice'=>"07240111216",
       	...
       	\App\Models\ElectronicInvoiceSettings::create([
        	'user_id'=>38,
        	'type'=>\App\Models\ElectronicInvoiceSettings::MIUR,
        	'dati_trasmissione_id_paese'=>"IT",
        	'dati_trasmissione_id_codice'=>"10209790152",
        	'dati_anagrafici_id_paese'=>"IT",
        	'dati_anagrafici_id_codice'=>"07240111216",
       	...
       	\App\Models\ElectronicInvoiceSettings::create([
        	'user_id'=>38,
        	'type'=>\App\Models\ElectronicInvoiceSettings::IIQ,
        	'dati_trasmissione_id_paese'=>"IT",
        	'dati_trasmissione_id_codice'=>"10209790152",
        	'dati_anagrafici_id_paese'=>"IT",
        	'dati_anagrafici_id_codice'=>"07240111216",

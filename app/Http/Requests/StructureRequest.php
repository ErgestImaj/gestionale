...
class StructureRequest extends FormRequest {
	...
	public function rules() {
		...
		$rules = [
			...
			'operational_town'    => 'sometimes|nullable|numeric|exists:location_towns,id',
			'operational_region'  => 'sometimes|nullable|numeric|exists:location_regions,id',
			'operational_prov'    => 'sometimes|nullable|numeric|exists:location_provs,id',
			'operational_country' => 'sometimes|nullable|numeric|exists:location_countries,id',
	...
	public function attributes() {
		...
		return [
			'nome'                => mb_strtolower( trans( 'form.nome_strutura' ) ,'UTF-8'),
			'legal_name'          => mb_strtolower( trans( 'form.ragione_sociale' ) ,'UTF-8'),
			'tax_code'            => 'codice fiscale',
			'legal_region'        => 'regione',
			'operational_region'  => 'regione',
			'legal_country'       => mb_strtolower( trans( 'form.country' ) ,'UTF-8'),
			'operational_country' => mb_strtolower( trans( 'form.country' ) ,'UTF-8'),
			'legal_town'          => 'città',
			'operational_town'    => mb_strtolower( trans( 'form.city' ) ,'UTF-8'),
			'legal_prov'          => mb_strtolower( trans( 'form.state' ) ,'UTF-8'),
			'operational_prov'    => mb_strtolower( trans( 'form.state' ) ,'UTF-8'),
			'legal_zipcode'       => mb_strtolower( trans( 'form.cap' ),'UTF-8' ),
			'operational_zipcode' => mb_strtolower( trans( 'form.cap' ),'UTF-8' ),
			'legal_address'       => mb_strtolower( trans( 'form.address' ),'UTF-8' ),
			'operational_address' => mb_strtolower( trans( 'form.address' ) ,'UTF-8'),
			'phone'               => mb_strtolower( trans( 'form.phone' ) ,'UTF-8'),
			'website'             => mb_strtolower( trans( 'form.site' ),'UTF-8' ),

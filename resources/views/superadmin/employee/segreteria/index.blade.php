...
@section('content')
    ...
    <div class="content-single">
        <div class="page-header">
            <h3 class="page-title">
                <span class="text-semibold"><i class="fas fa-list"></i>{{trans('headers.segreteria_users')}}</span>
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-title">
                    <div class="col-md-2">
                        <a href="{{route('admin.segreteria.create')}}"  class="btn btn-primary">
...
@push('scripts')
    ...
    <script src="{{asset('js/segreteria.js')}}"></script>

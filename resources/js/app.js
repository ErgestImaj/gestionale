...
Vue.component('basic-export', require('./components/export/basicExportComponent').default);
Vue.component('storehouse-export', require('./components/export/storehouseExportComponent').default);

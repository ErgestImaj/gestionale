        ...
        props: ['structureType'],
            ...
            return {
                ...
                headers: [
                    ...
                    { text: 'legal_prov', value: 'legal_prov' },
            ...
            this.getStructures();
				...
				methods: {
            getStructures() {
                axios.get(`/amministrazione/api/struture/all`)
                    .then(response => {
            ...
            addStrutura() {
                let nUrl = window.location.origin + '/amministrazione/struture/create';

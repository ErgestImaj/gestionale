                          ...
                          <div class="row">
                              <div class="col-lg-12">
                                  <div class="form-group">
                                      ...
                                      <input type="text" v-model="module.name"  id="input-first-name" :class="{'is-invalid': errors.name}" class="form-control" >
                                      <div class="invalid-feedback" v-if="errors.name">{{errors.name[0]}}</div>
                                  </div>

                                  <div class="form-group">
                                      <label class="form-control-label" for="input-code">{{trans('form.code_module')}}</label>
                                      <input type="text" v-model="module.code"  id="input-code" :class="{'is-invalid': errors.code}" class="form-control" >
                                  ...
                                  <div class="form-group">
                                      ...
                                      <textarea  v-model="module.description" :class="{'is-invalid': errors.description}" class="form-control"  id="description" rows="4"></textarea>
                                      <div class="invalid-feedback" v-if="errors.description">{{errors.description[0]}}</div>
                                  </div>
                              </div>
                              <div class="col-lg-12">
                                  <a class="btn-info btn" href="#" :disabled="submiting" @click.prevent="create">
                               ...
                               <table class="table table-hover ">
                                   ...
                                   <tr v-for="m in modules">
                                       ...
                                       <td class="d-sm-table-cell">
                                           <a class="btn block-btn btn-dark" :data-tooltip="trans('headers.edit_module')" href="#">
